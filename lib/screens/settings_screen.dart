  ...
  Widget _buildDeviceSection(BuildContext context) {
    return Padding(
      ...
      child: _buildSettingsCard(
        children: [
          _buildSettingsItem(
            iconColor: const Color(0xFF26A5FF), icon: Icons.wifi, label: 'Wi-Fi',
            onTap: () => context.go('/wifi'),
          ),
          _buildDivider(),
          _buildSettingsItem(
            iconColor: const Color(0xFF26A5FF), icon: Icons.bluetooth, label: 'Bluetooth',
  ...
  Widget _buildPrivacySection(BuildContext context) {
    return Padding(
      ...
      child: _buildSettingsCard(
        children: [
          _buildSettingsItem(
            iconColor: AppColors.primary700, icon: Icons.description_outlined, label: '利用規約',
            onTap: () => context.go('/terms-of-service'),
          ),
          _buildDivider(),
          _buildSettingsItem(
            iconColor: const Color(0xFFF44F4F), icon: Icons.notifications_outlined, label: '通知',
            onTap: () => context.go('/notification-settings'),
          ),
          _buildDivider(),
          _buildSettingsItem(
            iconColor: const Color(0xFF26A5FF), icon: Icons.shield_outlined, label: 'プライバシー',
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                'ログアウト',
                style: GoogleFonts.zenMaruGothic(
                  color: AppColors.error, fontSize: 24, fontWeight: FontWeight.w900, height: 1.20,
                ),
              ),
            ],
          ),
          ...
          actions: [
            TextButton(
              ...
              child: Text(
                'キャンセル',
                style: GoogleFonts.zenMaruGothic(
                  color: const Color(0xFFB9BFC9), fontSize: 16, fontWeight: FontWeight.w700,
                ),
              ),
            ),
            TextButton(
              ...
              child: Text(
                'ログアウト',
                style: GoogleFonts.zenMaruGothic(
                  color: AppColors.error, fontSize: 16, fontWeight: FontWeight.w900,
                ),
              ),
            ),
          ],
